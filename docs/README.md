...
- [phase6/73d R2 上界、样本量与清单准备计算记录](phase6/73d-m8-r2-bound-sample-and-manifest-preparation-record.md)：当前入口；记录基于既有裁定的解析计算与准备方案，**不等于冻结、运行或质量结论**。
...
- [phase6/73 v10 后质量框架与路线决策草案](phase6/73-m8-post-v10-quality-framework-and-route-decision-draft.md)：路线决策草案（含甲/乙/丙三选项与后果），已被 `73a` / `73b` / `73c` / `73d` 承接。
...
| [`phase6/`](phase6/) | 55–58n、60–73d | 独立质量验证、可诊断性升级、签收与只读诊断；`73` 起为 v10 后的质量框架与路线决策。 |
