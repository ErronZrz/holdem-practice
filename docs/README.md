...
- [phase6/73 v10 后质量框架与路线决策草案](phase6/73-m8-post-v10-quality-framework-and-route-decision-draft.md)：当前**待裁定**的路线决策（未来 L4 的角色与质量框架），是本轮唯一入口。
...
| [`phase6/`](phase6/) | 55–58n、60–73 | 独立质量验证、可诊断性升级、签收与只读诊断；`73` 起为 v10 后的质量框架与路线决策。 |
