...
- [phase6/73b 长期·分层·配对框架预注册草案](phase6/73b-m8-long-term-stratified-paired-framework-preregistration-draft.md)：当前**待审查**的框架预注册草案（统计对象 / 基线池 / 主判层 / 功效依据 / 状态机 / 双口径角色），是本轮唯一入口。
